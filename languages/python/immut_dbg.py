"""
    This module is intend to be used for debugging only.
...
def is_frozen(obj_or_cls):
    try: return (obj_or_cls.__class__.__setattr__.__module__ == __name__)
    except: pass
    try: return (obj_or_cls.__setattr__.__module__ == __name__)
    except: pass
    return False
