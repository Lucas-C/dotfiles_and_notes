...
def main(argv):
    ...
    password = getpass.getpass(prompt='Password for user {} : '.format(args.user))
    ...
    with pysftp.Connection(args.host, username=args.user, password=password, cnopts=cnopts) as sftp:
